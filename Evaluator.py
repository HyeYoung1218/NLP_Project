...
class Evaluator:
    ...
    def get_score(self, model, dataset, mode, eval_id, test_num=None):
        ...
        if len(set(dataset.idx2qtype.values()) - set(str(i) for i in list(range(10)))) != 8:
            type_set = sorted(list(set(dataset.idx2qtype.values()) - set(str(i) for i in list(range(10)))))
        else:
